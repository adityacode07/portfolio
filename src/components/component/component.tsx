...
<div className="flex flex-col min-h-[100dvh]">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
              <div className="bg-muted rounded-lg p-4 flex flex-col items-center">
                ...
                <p className="text-muted-foreground text-sm">
                  Proficient in modern JavaScript, including ES6+ features and popular frameworks/libraries like React,
                  and Next.
                </p>
              </div>
              <div className="bg-muted rounded-lg p-4 flex flex-col items-center">
              ...
              <div className="bg-muted rounded-lg p-4 flex flex-col items-center">
                ...
                <p className="text-muted-foreground text-sm">
                  Familiar with cloud platforms like AWS for hosting and deploying web
                  applications.
                </p>
              </div>
              <div className="bg-muted rounded-lg p-4 flex flex-col items-center">
                ...
                <p className="text-muted-foreground text-sm">
                  Proficient styling with Tailwind CSS and vanilla CSS, leveraging modern techniques for responsive design and layout
                </p>
              </div>
              <div className="bg-muted rounded-lg p-4 flex flex-col items-center">
                ...
                <p className="text-muted-foreground text-sm">
                  Experience building scalable and secure backend systems using Node.js, Express, and other server-side
                  technologies.
                </p>
              </div>
              <div className="bg-muted rounded-lg p-4 flex flex-col items-center">
  ...
  rel="noopener noreferrer"
        ...
        <section id="articles" className="py-12 md:py-20 px-6 md:px-12">
          <div className="container mx-auto max-w-4xl">
            <h2 className="text-3xl font-bold mb-8">My Articles</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
  ...
  rel="noopener noreferrer"
              ...
              <div className="bg-muted rounded-lg overflow-hidden shadow-md">
                ...
                <div className="p-4">
                  ...
                  Mastering Data Validation with Zod in Your Backend
                  </h3>
                  <p className="text-muted-foreground mb-4">
    ...
    <div className="bg-background rounded-lg p-6 shadow-md">
      ...
      <footer className="bg-primary text-primary-foreground py-6 px-6">
        <div className="container mx-auto max-w-4xl flex items-center justify-between">
          <p className="text-sm">&copy; 2024 Aditya Yadav. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
